...
namespace LocalMartOnline.Services.Implement
{
    public class ReportService : IReportService
    {
        ...
        }        public async Task<ReportDto?> CreateReportAsync(string reporterId, string reporterRole, CreateReportDto createReportDto)
        {
            ...
            var validTargetTypes = new[] { "Product", "Seller", "Buyer" };
