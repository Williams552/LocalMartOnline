...
namespace LocalMartOnline.Models.DTOs.User
{
    public class UserStatisticsDto
    {
        ...
        public EngagementMetricsDto EngagementMetrics { get; set; } = new EngagementMetricsDto();
    ...
    public class EngagementMetricsDto
    {
        ...
        public Dictionary<string, int> InteractionsByType { get; set; } = new Dictionary<string, int>();
